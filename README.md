# AlignLLM: Investigating the Inner Mechanisms of Alignment-Based LLM Evaluation
...
- Context results for generation and embedding phase datasets: https://huggingface.co/datasets/Ramitha/unique-records-snippet-combination-all , https://huggingface.co/datasets/Ramitha/snippet-less-output-all-models-all
